...
public class IncidentRepository {
    ...
    public List<Incident> findAll(String type, String severity, LocalDateTime startDate, LocalDateTime endDate, String status) {
    ...
    public Incident update(Integer incidentId, Incident incident) {
        String sql = "UPDATE incidents SET title = ?, description = ?, incident_type = ?, " +
                     "severity_level = ?, incident_date = ?, status = ?, updated_at = CURRENT_TIMESTAMP " +
                     "WHERE incident_id = ?";
    ...
    public void updateStatus(Integer incidentId, String status) {
        String sql = "UPDATE incidents SET status = ?, updated_at = CURRENT_TIMESTAMP";
        ...
        jdbcTemplate.update(sql, status, incidentId);
    }
